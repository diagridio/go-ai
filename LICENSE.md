...
**Licensed Work:** Diagrid AI Infrastructure SDK for Go
...
The Licensor grants permission to make production use of the Licensed Work without purchasing a commercial license **only if all of the following conditions are satisfied**.
...
The Licensed Work may **not** be used in production if it is:

- Offered as a **managed, hosted, or Software-as-a-Service (SaaS) offering**, or
...
Any production use that does **not satisfy all of the above conditions** requires a valid commercial license from **Diagrid Inc**.

The Additional Use Grant above **supersedes the “non-production use” limitation** described in the Terms section for users who meet these conditions.
...
On the Change Date, or the fourth anniversary of the first publicly available distribution of a specific version of the Licensed Work under this License (whichever comes first), the Licensed Work will automatically be licensed under:
...
This license is based on the Business Source License 1.1 with
modifications by Diagrid Inc.

The MariaDB covenant provisions have been removed and the
Change License has been designated as the Apache License,
Version 2.0.
...
Production use is permitted only as allowed under the **Additional Use Grant**.
...
This License applies separately for each version of the Licensed Work, and the Change Date may vary for each version released by the Licensor.
...
The rights granted under this License are **conditioned upon compliance with all terms and restrictions of this License**.

Any use of the Licensed Work that does not comply with these terms **constitutes copyright infringement** and automatically terminates the rights granted under this License for the current and all other versions of the Licensed Work.

---

This License does **not grant you any right to use any trademark, service mark, or logo** of Diagrid Inc or its affiliates.
